...
struct CharacterStickerLibrary {
  static let all: [CharacterSticker] = [
    CharacterSticker(
      name: "Nova", imageName: "character01", accent: Color(red: 0.98, green: 0.36, blue: 0.56)),
    CharacterSticker(
      name: "Orbit", imageName: "character02", accent: Color(red: 0.64, green: 0.76, blue: 0.95)),
    CharacterSticker(
      name: "Luma", imageName: "character03", accent: Color(red: 0.99, green: 0.82, blue: 0.36)),
    CharacterSticker(
      name: "Vale", imageName: "character04", accent: Color(red: 0.70, green: 0.88, blue: 0.86)),
    CharacterSticker(
      name: "Flux", imageName: "character05", accent: Color(red: 1.00, green: 0.41, blue: 0.35)),
    CharacterSticker(
      name: "Rei", imageName: "character06", accent: Color(red: 1.00, green: 0.53, blue: 0.34)),
    CharacterSticker(
      name: "Moss", imageName: "character07", accent: Color(red: 0.96, green: 0.65, blue: 0.76)),
    CharacterSticker(
      name: "Ivy", imageName: "character08", accent: Color(red: 0.98, green: 0.76, blue: 0.58)),
    CharacterSticker(
      name: "Wren", imageName: "character09", accent: Color(red: 0.87, green: 0.54, blue: 0.95)),
    CharacterSticker(
      name: "Ash", imageName: "character10", accent: Color(red: 0.60, green: 0.70, blue: 0.96)),
  ]
